      ...
      //       let afficher = document.getElementById.sprites.front_shiny
      //     });
...
//     // Construit l'URL pour la requête à l'API Pokémon en utilisant le nom du Pokémon fourni
//     const url = `https://pokeapi.co/api/v2/pokemon/${pokemonName}`;

//     // Démarre la requête à l'API
//     const response = await fetch(url);

//     // Vérifie si la réponse est réussie (status 200-299)
//     if (!response.ok) {
//         // Si la réponse n'est pas ok, affiche une erreur dans la console
//         console.error('Failed to fetch Pokémon:', response.status);
//         // Ici, vous pourriez choisir de retourner ou de faire quelque chose d'autre pour gérer l'erreur
//         return;
//     }

//     // Si la réponse est ok, convertit et retourne la réponse en JSON
//     const reponseJSon = await response.json();

//     // Affiche les données JSON obtenues de l'API dans la console
//     console.log(reponseJSon);
// }

// // Appelle la fonction avec 'ditto' comme exemple de Pokémon à rechercher
// fetchPokemon('ditto');
